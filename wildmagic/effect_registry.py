...
_EFFECT_META: dict[str, tuple[str, tuple[str, ...]]] = {
    ...
    "transform_entity": (
        ...
        ("target", "name", "char", "material", "hp", "attack", "defense", "tags"),
    ),
    "edit_memory": (
    ...
    "set_flag": ("Set a persistent world flag.", ("flag", "value")),
    "schedule_event": (
        "Create a delayed event that fires after N turns.",
        ("turns", "event_type", "effects", "text", "name"),
    ),
    "create_trigger": (
        "Create a charged reaction that fires when a later event happens.",
        ("trigger", "on", "target", "charges", "duration", "effects", "name"),
    ),
