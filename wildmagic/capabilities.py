...
{"accepted": true, "severity": "moderate", "outcome_text": "Your bones remember fire.", "effects": [{"type": "add_resistance", "target": "player", "damage_type": "fire", "amount": 50}], "costs": [{"type": "mana", "amount": 6}, {"type": "curse", "id": "ember_tongue", "name": "Ember Tongue", "description": "Your next promises taste faintly of smoke.", "semantic_prompt": "Let speech, bargains, and breath carry warm ash and unreliable sparks."}], "rejected_reason": null}
...
{"accepted": true, "severity": "catastrophic", "outcome_text": "The floor heaves and splits; the whole room comes down in a roar of stone and dust.", "effects": [{"type": "area_damage", "target": "player", "radius": 7, "amount": 22, "damage_type": "physical", "include_player": false, "affects": "enemies"}, {"type": "create_tiles", "target": "player", "radius": 6, "tile": "rubble", "duration": 0}], "costs": [{"type": "max_health", "amount": 3}, {"type": "curse", "id": "stone_hunger", "name": "Stone Hunger", "description": "Walls lean toward you as if remembering the collapse.", "semantic_prompt": "Let enclosed places, masonry, and buried things pull attention toward the caster."}], "rejected_reason": null}
...
_CONJURE_CREATURE = CapabilityCard(
    ...
    examples=(
        '{"accepted": true, "severity": "moderate", "outcome_text": "Two wolves pour out of the spell like spilled ink, tongues lolling, delighted.", "effects": [{"type": "conjure_creature", "template": "small_beast", "name": "shadow wolf", "count": 2, "faction": "ally", "tags": ["wolf", "predator"], "placement": "near_player"}], "costs": [{"type": "mana", "amount": 5}, {"type": "curse", "id": "shadow_scent", "name": "Shadow Scent", "description": "Predators notice the shape your shadow leaves behind.", "semantic_prompt": "Let summoned beasts, darkness, and hunting instincts tug future magic toward pursuit."}], "rejected_reason": null}',
    ...
    cost_hint="moderate-major; mana, sometimes a spell-specific curse for powerful or volatile summons",
...
_TRIGGERS_REACTIONS = CapabilityCard(
    ...
    examples=(
        ...
        '{"accepted": true, "severity": "major", "outcome_text": "Death must knock twice.", "effects": [{"type": "create_trigger", "name": "last-breath bargain", "trigger": "on_lethal_damage", "target": "player", "charges": 1, "duration": 8, "effects": [{"type": "heal", "target": "trigger_target", "amount": 8}]}], "costs": [{"type": "curse", "id": "second_breath", "name": "Second Breath", "description": "One borrowed breath lingers behind your ribs.", "semantic_prompt": "Let breath, pauses, suffocation, and last chances bend future spell prices."}], "rejected_reason": null}',
...
_SYMPATHETIC_LINK = CapabilityCard(
    ...
    examples=(
        ...
        '{"accepted": true, "severity": "major", "outcome_text": "You knot the goblin\'s nerves into the ogre\'s; one flinch will travel both ways.", "effects": [{"type": "create_persistent_effect", "kind": "sympathetic_link", "source": "goblin_3", "sink": "ogre_1", "mutual": true, "duration": 10}], "costs": [{"type": "mana", "amount": 5}, {"type": "curse", "id": "red_thread_nerves", "name": "Red-Thread Nerves", "description": "Pain tugs at you through invisible thread.", "semantic_prompt": "Let shared pain, twitching thread, and mirrored wounds complicate future spells."}], "rejected_reason": null}',
    ),
...
_PORTAL_GATES = CapabilityCard(
    ...
    examples=(
        '{"accepted": true, "severity": "moderate", "outcome_text": "The air tears open with a wet sucking sound; through the rift you can see the corridor you fled.", "effects": [{"type": "create_portal", "anchor": "player", "destination": "known", "turns": 6, "two_way": true}], "costs": [{"type": "mana", "amount": 5}, {"type": "curse", "id": "threshold_echo", "name": "Threshold Echo", "description": "Doorways answer a moment late when you cross them.", "semantic_prompt": "Let thresholds, arrivals, and doubled footsteps color future magic."}], "rejected_reason": null}',
    ),
